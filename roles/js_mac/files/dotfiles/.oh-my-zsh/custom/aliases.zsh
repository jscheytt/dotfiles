...
alias kdev='kubectx dev && kubens dev'
alias kint='kubectx dev && kubens int'
alias kint-old='kubectx nonprod && kubens int-0-otg'
alias kpre='kubectx dev && kubens preprod'
alias kpre-old='kubectx nonprod && kubens preprod-0-otg'
alias kprod='kubectx prod && kubens prod'
alias kprod-old='kubectx prod-old && kubens prod-0-otg'
alias ll='exa -la'
...
alias vn="vim -s <(printf 'B3jo2joGko')"
